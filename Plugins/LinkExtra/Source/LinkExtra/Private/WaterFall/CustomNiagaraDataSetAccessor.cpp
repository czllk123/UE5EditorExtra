...
bool FCustomNiagaraDataSetAccessor::Init(const FNiagaraDataSetCompiledData& CompiledData, FName InVariableName)
{
...
float FCustomNiagaraDataSetAccessor::ReadFloat(const FNiagaraDataBuffer* DataBuffer, uint32 Instance, uint32 Component) const
{
...
float FCustomNiagaraDataSetAccessor::ReadHalf(const FNiagaraDataBuffer* DataBuffer, uint32 Instance, uint32 Component) const
{
...
int32 FCustomNiagaraDataSetAccessor::ReadInt(const FNiagaraDataBuffer* DataBuffer, uint32 Instance, uint32 Component) const
{
...
bool FCustomNiagaraDataSetAccessor::ValidateDataBuffer(const FNiagaraDataSetCompiledData& CompiledData, const FNiagaraDataBuffer* DataBuffer, uint32 iInstance, TFunction<void(const FNiagaraVariable&, int32)> ErrorCallback)
{
	bool bIsValid = true;
...
bool FCustomNiagaraDataSetAccessor::ValidateDataBuffer(const FNiagaraDataSetCompiledData& CompiledData, const FNiagaraDataBuffer* DataBuffer, TFunction<void(const FNiagaraVariable&, uint32, int32)> ErrorCallback)
{
	bool bIsValid = true;
